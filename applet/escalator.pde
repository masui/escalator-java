...
float lgapfactor = 1.0;
float rspeedfactor = 1.0;
float rgapfactor = 1.0;
...
void setup(){
  ...
  lspeedfactor = (s == null ? 1.0 : parseFloat(s));
  s = param("rspeedfactor");
  rspeedfactor = (s == null ? 1.0 : parseFloat(s));
  s = param("lgapfactor");
  lgapfactor = (s == null ? 1.0 : parseFloat(s));
  s = param("rgapfactor");
  rgapfactor = (s == null ? 1.0 : parseFloat(s));
}
